      ...
      <main className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-sm ring-1 ring-black/5 dark:bg-zinc-900 dark:ring-white/10">
        ...
        <form action={formAction} className="flex flex-col gap-3">
          ...
          <button
            type="submit"
            disabled={isPending}
            className="mt-1 rounded-lg bg-blue-800 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-blue-900 disabled:opacity-50 dark:bg-blue-700 dark:hover:bg-blue-600"
          >
